...
// --- VERCEL ADAPTATION: IN-MEMORY STORAGE (EPHEMERAL) ---
// Note: Data will reset when the server restarts (cold start).
// For permanent storage, use MongoDB Atlas + Cloudinary.

const storage = multer.memoryStorage(); // Use RAM instead of Disk
const upload = multer({ storage: storage });

// In-Memory Database (Fallback)
global._appsDB = global._appsDB || [];

const readDB = () => global._appsDB;
const writeDB = (data) => { global._appsDB = data; };
